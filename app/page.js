...
var IFC3DViewer = dynamic(function() { return import('../components/IFCViewer'); }, { ssr: false, loading: function() { return <div style={{height:500,display:'flex',alignItems:'center',justifyContent:'center'}}><span className="mono" style={{color:'var(--dim)'}}>Loading 3D...</span></div>; } });
  ...
  return (
    <div className="animate-fade">
      <div style={{ display:'flex', gap:4, marginBottom:16, overflowX:'auto' }}>
        {[
          { id:'dashboard', label:'📊 Dashboard' }, { id:'3d', label:'🧊 3D View' }, { id:'marks', label:'🏗 Marks (' + parts.length + ')' },
      ...
      {subTab === '3d' && (
        <IFC3DViewer parts={parts} erectedPartIds={erectedPartIds} fabSummary={fabSummary} ifcMarks={ifcMarks || []} />
      )}
  ...
  return (
    <div className="glass-card" style={{ padding:16, borderLeft:'3px solid #a78bfa' }}>
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:12 }}>
        <div style={{ display:'flex', alignItems:'center', gap:8 }}>
          <span style={{ fontSize:16 }}>📄</span>
          <span className="mono" style={{ fontSize:11, color:'var(--dim)', letterSpacing:2, fontWeight:600 }}>IFC MARK MATCHING</span>
        </div>
        {auth.isPM && (
  ...
  return (
    <div className="glass-card" style={{ padding:16, marginTop:12, borderLeft:'3px solid #a78bfa' }}>
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:12 }}>
        <div style={{ display:'flex', alignItems:'center', gap:8 }}>
          <span style={{ fontSize:16 }}>🔐</span>
          <span className="mono" style={{ fontSize:11, color:'var(--dim)', letterSpacing:2, fontWeight:600 }}>PROJECT ACCESS</span>
        </div>
