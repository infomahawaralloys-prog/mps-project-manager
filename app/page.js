...
var COLDFORM_STAGES = ['cutting','dispatch','erection'];
var COLDFORM_STAGE_LABELS = { cutting:'Roll Forming', dispatch:'Dispatch', erection:'Erection' };
...
function FabTab({ project, auth }) {
  ...
  CATEGORIES.forEach(function(cat) {
    ...
    var done = 0;
    cp.forEach(function(p) { var fs = fabSummary[p.id]; if (fs) { done += (cat === 'builtup' || cat === 'coldform') ? (fs.erection || 0) : (fs.cutting || 0); } });
        ...
        <div className="glass-card" style={{ padding:16, marginBottom:16, borderLeft:'3px solid #38bdf8' }}>
          <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:12 }}>
            ...
            <span className="mono" style={{ fontSize:12, color:'var(--dim)', letterSpacing:2, fontWeight:600 }}>
              {isColdformCat ? '3-STAGE PIPELINE' : '8-STAGE PIPELINE'}
            </span>
          </div>
