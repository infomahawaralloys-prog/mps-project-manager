...
function ErectionTab({ project, auth }) {
  ...
  return (
    <div className="animate-fade">
      ...
      {subTab === '3d' && (
        <Lazy3DViewer parts={parts} erectedPartIds={erectedPartIds} fabSummary={fabSummary} ifcMarks={[]} />
      )}
...
function Lazy3DViewer(props) {
  var [Viewer, setViewer] = useState(null);
  useEffect(function() {
    import('../components/IFCViewer').then(function(mod) {
      setViewer(function() { return mod.default; });
    });
  }, []);
  if (!Viewer) return (
    <div className="glass-card" style={{ height:500, display:'flex', alignItems:'center', justifyContent:'center' }}>
